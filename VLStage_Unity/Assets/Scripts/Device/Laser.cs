...
namespace IA
{
    ...
    public class Laser : DMXFixture
    {
        ...
        private Dictionary<string, int> channelFunctions = new Dictionary<string, int> { { ChannelName.RED, 0 }, { ChannelName.GREEN, 1 }, { ChannelName.BLUE, 2 }, { ChannelName.DIMMER, 3 }, { ChannelName.TILT, 4 }, { ChannelName.MUL, 5 }, { ChannelName.DIV, 6 } };
        ...
        void SetTilt()
        {
            ...
            tilt = tiltMotor.localEulerAngles.x;
        }
        ...
        void UpdateRotation()
        {
            ...
            if (0 != dtilt)
            {
                tiltMotor.transform.localEulerAngles = new Vector3(-tiltTarget/2, -90, 0);
            }
        }
        ...
        void SetColor()
        {
            ...
            color.a = artNetData.dmxDataMap[universe - 1][dmxAddress - 1 + (int)channelFunctions[ChannelName.DIMMER]] / 256f;
